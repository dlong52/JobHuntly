...
const CVModel1 = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 rounded-l">
      {/* Profile Section */}
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex flex-col items-start text-gray-600 gap-y-1 border-l-4 border-blue-800 p-4 rounded-md">
