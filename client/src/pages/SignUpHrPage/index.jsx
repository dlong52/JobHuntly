...
const SignUpHrPage = () => {
  ...
  return (
    <Box className="w-full min-h-screen relative grid grid-cols-1 gap-10 md:grid-cols-12 bg-blue-950 p-10">
      <Box className="col-span-8 flex flex-col items-center justify-center gap-y-4 px-4 md:px-0">
        <Box className="size-full bg-white  gap-y-4 px-4 md:px-0 rounded-xl">
          <Link to={"/"}>
            <Logo />
          </Link>
      ...
      <Box className="col-span-4 h-full flex justify-center items-center">
        <img
