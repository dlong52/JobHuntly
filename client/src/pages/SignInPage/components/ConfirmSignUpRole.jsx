      ...
      <Box className="py-5">
        <Box className="flex max-w-[830px] py-5">
          <Box className="flex-1 mr-4 flex flex-col items-center">
            ...
            <Link to={"/sign-up"} className="rounded-full px-8 py-3 bg-primary text-white">Tôi là nhà tuyển dụng</Link>
          </Box>
          <Box className="flex-1 mr-4 flex flex-col items-center">
            <img className="w-full" src={Candidate} alt="" />
            <Link to={"/sign-up-hr"} className="rounded-full px-8 py-3 bg-primary text-white">Tôi là nhà ứng viên tìm việc</Link>
          </Box>
        </Box>
      </Box>
    </Box>
